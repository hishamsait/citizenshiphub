...
The Iran passport offers visa-free, visa-on-arrival, ETA, or e-visa access to **90** destinations, ranking it **#189** globally.

> Descent via father; dual not recognised.

## Citizenship by descent

Iran applies jus sanguinis — citizenship can be acquired by descent from a citizen parent, and in some cases from grandparents or more distant ancestors.
...
Iran generally does not permit dual citizenship — naturalising usually requires renouncing your existing nationality.
