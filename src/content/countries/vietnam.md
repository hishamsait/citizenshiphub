...
The Vietnam passport offers visa-free, visa-on-arrival, ETA, or e-visa access to **105** destinations, ranking it **#138** globally.

> Dual for overseas Vietnamese (exceptions).

## Citizenship by descent

Vietnam applies jus sanguinis — citizenship can be acquired by descent from a citizen parent, and in some cases from grandparents or more distant ancestors.
...
Vietnam generally does not permit dual citizenship — naturalising usually requires renouncing your existing nationality.
